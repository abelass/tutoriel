...
function tutoriel_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_tutos'] = array(
		...
		'field'=> array(
			...
			'quantite_tissu'     => 'varchar(25) NOT NULL DEFAULT ""',
		...
		'date' => 'date',
		'champs_editables'  => array('titre', 'descriptif', 'format', 'niveau', 'matiere', 'resultat', 'quantite_tissu', 'id_rubrique', 'id_secteur'),
		'champs_versionnes' => array('titre', 'descriptif', 'format', 'niveau', 'matiere', 'resultat', 'quantite_tissu', 'id_rubrique', 'id_secteur'),
