...
function tutoriel_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_tutos'] = array(
		...
		'date' => 'date',
		'champs_editables'  => array('titre', 'descriptif', 'url', 'resultat', 'commentaires', 'id_rubrique', 'id_secteur'),
		'champs_versionnes' => array('titre', 'descriptif', 'url', 'resultat', 'commentaires', 'id_rubrique', 'id_secteur'),
		'rechercher_champs' => array("titre" => 10, "descriptif" => 8, "resultat" => 8, "commentaires" => 4),
